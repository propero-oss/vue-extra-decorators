...
[Home](./index.md) &gt; [@propero/vue-extra-decorators](./vue-extra-decorators.md) &gt; [NProp](./vue-extra-decorators.nprop.md)

## NProp() function

Declares a Vue property. Number flavor of [@Prop](./vue-extra-decorators.prop.md) decorator

<b>Signature:</b>

```typescript
export declare function NProp(opts?: PropOpts<number>): TypedVueDecorator<number>;
```
